<#
.SYNOPSIS
    Every repository: env files with git standing, variables, secrets, missing in code, unused, template drift, risk. Values are never included.
.EXAMPLE
    ./scripts/Get-EnvReport.ps1
#>
[CmdletBinding()]
param(
